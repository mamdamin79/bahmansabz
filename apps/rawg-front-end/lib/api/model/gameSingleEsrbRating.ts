 ...
 */
import type { GameSingleEsrbRatingSlug } from './gameSingleEsrbRatingSlug';
import type { GameSingleEsrbRatingName } from './gameSingleEsrbRatingName';

/**
 * @nullable
 */
export type GameSingleEsrbRating = {
  id?: number;
  slug?: GameSingleEsrbRatingSlug;
  name?: GameSingleEsrbRatingName;
} | null;
